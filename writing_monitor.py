...
class CollectTrainingStatsApp(simple_switch_13.SimpleSwitch13):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not os.path.exists('/home/alessandro/FlowStatsfile.txt'):
            os.mknod('/home/alessandro/FlowStatsfile.txt')
        file = open("/home/alessandro/FlowStatsfile.txt","a+")
        file.write('dp_id,in_port,eth_dst,packets,bytes')
        file.close()

        if not os.path.exists('/home/alessandro/PortStatsfile.txt'):
            os.mknod('/home/alessandro/PortStatsfile.txt')
        file = open("/home/alessandro/PortStatsfile.txt","a+")
        file.write('dp_id,port_no,rx_bytes,rx_pkts,tx_bytes,tx_pkts')
        file.close()

        if not os.path.exists('/home/alessandro/FlowStatsfile_target.txt'):
            os.mknod('/home/alessandro/FlowStatsfile_target.txt')
        file = open("/home/alessandro/FlowStatsfile_target.txt","a+")
        file.write('target')
        file.close()

        if not os.path.exists('/home/alessandro/PortStatsfile_target.txt'):
            os.mknod('/home/alessandro/PortStatsfile_target.txt')
        file = open("/home/alessandro/PortStatsfile_target.txt","a+")
        file.write('target')
        file.close()
    ...
    def _flow_stats_reply_handler(self, ev):
        ...
        file = open("/home/alessandro/FlowStatsfile.txt","a+")
        file1=open("/home/alessandro/FlowStatsfile_target.txt","a+")
    ...
    def _port_stats_reply_handler(self, ev):
        ...
        file = open("/home/alessandro/PortStatsfile.txt","a+")
        file1 = open("/home/alessandro/PortStatsfile_target.txt","a+")
